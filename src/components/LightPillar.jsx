...
const LightPillar = ({
  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // Set background to white instead of black
        vec3 finalColor = mix(vec3(1.0), color * uIntensity, length(color));
  ...
  if (!webGLSupported) {
    return (
      <div
        className={`w-full h-full absolute top-0 left-0 flex items-center justify-center bg-white/10 text-gray-500 text-sm ${className}`}
