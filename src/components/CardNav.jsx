...
const CardNav = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* TOP BAR */}
        <div className="absolute inset-x-0 top-0 h-[60px] flex items-center  xl:justify-center justify-between px-4 z-10">
          <button
            onClick={toggleMenu}
          ...
          <button
            className="block xl:hidden md:flex items-center gap-1 px-4 py-2 rounded-full font-medium cursor-pointer"
