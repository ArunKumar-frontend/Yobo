...
const Services = () => {
  ...
  return (
   ...
   <div className='flex justify-center items-center gap-5 p-10 w-full '>
     <div className="border border-black/[0.2] dark:border-white/[0.2] flex flex-col items-start w-full p-4 relative h-[30rem]">
